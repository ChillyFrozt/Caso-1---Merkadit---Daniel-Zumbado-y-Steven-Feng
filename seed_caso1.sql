...
TRUNCATE TABLE categoriaKioskos;
TRUNCATE TABLE tipoKioskos;
TRUNCATE TABLE estadoKioskos;
TRUNCATE TABLE tipoComercios;
TRUNCATE TABLE estadoComercios;
...
INSERT INTO addresses (addressName, cityid, geolocation, codigoPostal, direccion1, direccion2, deleted, postTime)
VALUES ('Av Central #123', @city, ST_GeomFromText('POINT(-84.082 9.934)', 4326),'10101','Edificio Principal','Piso 2',b'0',NOW());
...
INSERT INTO buildings (buildingName, addressid, created_by, updated_at, deleted_at, maxAncho, maxLargo)
VALUES ('Edificio Verduras', @addr, 1, NOW(), NOW(), 50.00, 50.00);
SET @bld_verd := LAST_INSERT_ID();

INSERT INTO buildings (buildingName, addressid, created_by, updated_at, deleted_at, maxAncho, maxLargo)
VALUES ('Edificio Frutas', @addr, 1, NOW(), NOW(), 50.00, 50.00);
SET @bld_frut := LAST_INSERT_ID();

INSERT INTO buildings (buildingName, addressid, created_by, updated_at, deleted_at, maxAncho, maxLargo)
VALUES ('Edificio Carnes', @addr, 1, NOW(), NOW(), 50.00, 50.00);
SET @bld_carn := LAST_INSERT_ID();

INSERT INTO buildings (buildingName, addressid, created_by, updated_at, deleted_at, maxAncho, maxLargo)
VALUES ('Edificio Lácteos', @addr, 1, NOW(), NOW(), 50.00, 50.00);
SET @bld_lact := LAST_INSERT_ID();

-- tipo de mercado
INSERT INTO tipoMercados (tipoMercadoName, deleted) VALUES ('Supermercado', b'0');
SET @tmerc := LAST_INSERT_ID();

-- 4 áreas/lugares, cada una en su edificio respectivo
INSERT INTO mercados (mercadoName, mercadoDescripcion, mercadoTelefono, created_by, addressid, tipoMercadoid, maxAncho, maxLargo, buildingid)
...
VALUES ('Verdulería', 0);
SET @tcom := LAST_INSERT_ID();


-- 3) CAT/KIOSKO/ESTADOS/TIPOS COMERCIO
INSERT INTO estadoKioskos (estadoKioskoName)
SELECT 'Activo'
FROM DUAL
WHERE NOT EXISTS (
  SELECT 1 FROM estadoKioskos WHERE estadoKioskoName = 'Activo'
);
-- Guardar id en @ek
...
INSERT INTO categoriaKioskos (categoriaKioskoName, deleted)
SELECT 'Pequeño', b'0'
FROM DUAL
WHERE NOT EXISTS (
  SELECT 1 FROM categoriaKioskos WHERE categoriaKioskoName = 'Pequeño'
);
SELECT categoriaKioskoid INTO @ck
FROM categoriaKioskos
WHERE categoriaKioskoName = 'Pequeño'
LIMIT 1;

-- Tipo de kiosko "Puesto" (idempotente) 
INSERT INTO tipoKioskos (tipoKioskoName, deleted)
SELECT 'Puesto', b'0'
FROM DUAL
WHERE NOT EXISTS (
  SELECT 1 FROM tipoKioskos WHERE tipoKioskoName = 'Puesto'
);
...
-- 4) USUARIO y OWNER
INSERT INTO usuarios (usuarioName, usuarioPassword, enabled, deleted, created_at, deleted_at, updated_at)
VALUES ('admin', CAST('admin123' AS BINARY), b'1', b'0', NOW(), NOW(), NOW());
SET @usr := LAST_INSERT_ID();

INSERT INTO owners (usuarioid, enabled, created_at, updated_at, deleted_at, deleted)
VALUES (@usr, b'1', NOW(), NOW(), NOW(), b'0');
SET @own := LAST_INSERT_ID();


-- 5) 4 KIOSKOS (IDs distintos y en mercados distintos)
INSERT INTO kioskos (kioskoCost, categoriaKioskoid, estadoKioskoid, tipoKioskoid, ancho, largo, mercadoid)
...
INSERT INTO comercios (comercioName, created_at, created_by, tipoComercioid, cedulaJuridica, razonSocial, contractid, deleted, estadoComercioid)
...
INSERT INTO categoriaProductos (categoriaProductoName, categoriaProductoDescripcion)
...
-- Verduras Mary
INSERT INTO productos (productoName, productoPrecio, productoCantidad, fechaLlegada, descripcion,
                       deleted, enabled, comercioid, categoriaProductoid, created_at, created_by, updated_at, updated_by)
VALUES ('Tomate', 500.00, 100.00, CURDATE(), 'Tomate rojo fresco',
        b'0', b'1', @com1, @cat, NOW(), @usr, NOW(), @usr);
SET @p1 := LAST_INSERT_ID();

INSERT INTO facturas (total, numeroFactura, descuento, ivaTotal, metodoDePagoid, usuarioid, subtotal, created_at, updated_at, comercioid)
VALUES (5000.00, 1001, 0.00, 650.00, @mp, @usr, 4350.00, NOW(), NOW(), @com1);
SET @f1 := LAST_INSERT_ID();


INSERT INTO detallesFactura (facturaid, productoid, cantidad, subtotal, precioUnitario, ivaAplicado, deleted)
VALUES (@f1, @p1, 10.00, 4350.00, 435.00, 650.00, b'0');

-- Frutas Juan
INSERT INTO productos (productoName, productoPrecio, productoCantidad, fechaLlegada, descripcion,
                       deleted, enabled, comercioid, categoriaProductoid, created_at, created_by, updated_at, updated_by)
VALUES ('Banano', 200.00, 300.00, CURDATE(), 'Banano criollo',
        b'0', b'1', @com2, @cat, NOW(), @usr, NOW(), @usr);
SET @p2 := LAST_INSERT_ID();

INSERT INTO facturas (total, numeroFactura, descuento, ivaTotal, metodoDePagoid, usuarioid, subtotal, created_at, updated_at, comercioid)
VALUES (6000.00, 2001, 0.00, 690.00, @mp, @usr, 5310.00, NOW(), NOW(), @com2);
SET @f2 := LAST_INSERT_ID();

INSERT INTO detallesFactura (facturaid, productoid, cantidad, subtotal, precioUnitario, ivaAplicado, deleted)
VALUES (@f2, @p2, 30.00, 5310.00, 177.00, 690.00, b'0');

-- Carnes Pepe
INSERT INTO productos (productoName, productoPrecio, productoCantidad, fechaLlegada, descripcion,
                       deleted, enabled, comercioid, categoriaProductoid, created_at, created_by, updated_at, updated_by)
VALUES ('Carne molida', 3500.00, 80.00, CURDATE(), 'Carne molida 90/10',
        b'0', b'1', @com3, @cat, NOW(), @usr, NOW(), @usr);
SET @p3 := LAST_INSERT_ID();

INSERT INTO facturas (total, numeroFactura, descuento, ivaTotal, metodoDePagoid, usuarioid, subtotal, created_at, updated_at, comercioid)
VALUES (35000.00, 3001, 0.00, 4030.00, @mp, @usr, 30970.00, NOW(), NOW(), @com3);
SET @f3 := LAST_INSERT_ID();

INSERT INTO detallesFactura (facturaid, productoid, cantidad, subtotal, precioUnitario, ivaAplicado, deleted)
VALUES (@f3, @p3, 10.00, 30970.00, 3097.00, 4030.00, b'0');

-- Lácteos Ana
INSERT INTO productos (productoName, productoPrecio, productoCantidad, fechaLlegada, descripcion,
                       deleted, enabled, comercioid, categoriaProductoid, created_at, created_by, updated_at, updated_by)
VALUES ('Leche entera', 900.00, 200.00, CURDATE(), 'Leche 1L',
        b'0', b'1', @com4, @cat, NOW(), @usr, NOW(), @usr);
SET @p4 := LAST_INSERT_ID();

INSERT INTO facturas (total, numeroFactura, descuento, ivaTotal, metodoDePagoid, usuarioid, subtotal, created_at, updated_at, comercioid)
VALUES (9000.00, 4001, 0.00, 1040.00, @mp, @usr, 7960.00, NOW(), NOW(), @com4);
SET @f4 := LAST_INSERT_ID();

INSERT INTO detallesFactura (facturaid, productoid, cantidad, subtotal, precioUnitario, ivaAplicado, deleted)
VALUES (@f4, @p4, 10.00, 7960.00, 796.00, 1040.00, b'0');
